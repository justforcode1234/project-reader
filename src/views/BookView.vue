...
<template>
    <div class="w-100% md:w-90% lg:w-80% mx-auto flex flex-col gap-y-5">
        <div class="flex flex-col md:flex-row gap-x-10 bg-yellow items-center py-20">
            <div class="md:self-start w-200 mt-5">
                <img class="w-full r-5" src="@/assets/images/cover/cover1.jpg" alt="">
            </div>
            <div class="w-full bg-[rgb(15,20,32,0.6)] flex flex-col md:flex-row p-15 gap-5 r-10">
                <div class="flex flex-col gap-y-2 w-fit">
                    ...
                    <div class="flex w-full gap-10 items-center justify-center mt-10">
                        <img class="w-35" src="@/assets/images/common/full-star.svg" alt="">
                        <div class="w-1 h-30 bg-black"></div>
        ...
        <div class="flex flex-col gap-y-5">
            <h1>Summary</h1>
            <p>Yeon-woo had a twin brother who disappeared five years ago. One day, a pocket watch left by his brother returned to his possession. Inside, he found a hidden diary in which was recorded “By the time you hear this, I guess I will be already dead….” Obelisk, the Tower of the Sun God, a world where several universes and dimensions intersect. In this world, his brother had fallen victim to betrayal while climbing up the tower. After learning the truth, Yeon-woo decided to climb the tower along with his brother’s diary. “From now on, I am Jeong-woo Cha.”</p>
        </div>
        <div>
            <div>
                <div></div>
            ...
            <div class="w-full">
                ...
                <div class="grid md:grid-cols-2 gap-x-5">
                    <CardChapter class="bg-transparent w-full [border-bottom:1px_solid_red]" v-for="chapter in chapter.chaps" :key="chapter.id" :chapter="chapter"/>
                </div>
            </div>
        </div>
    </div>
